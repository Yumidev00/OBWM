...
## Copyright (C) 2021-2022 Yumi Takanashi <yumidev00@gmail.com>
...
# compositor --------------------------------
compositor() {
	comp_file="$HOME/.config/openbox/polybar/picom.conf"
...
# funct WALLPAPER
set_wallpaper 'sad.png'

# funct STYLE FONT
change_polybar 'Yumi' 'JetBrains Mono:size=10;3' && "$polybar_path"/launch.sh

# funct STYLE FONT BORDER BORDER-RADIUS ICON (Change colors in funct)
change_rofi 'Yumi' 'Iosevka 10' '0px 0px 0px 0px' '0px' 'Zafiro'
...
obconfig 'White' 'CLM' 'JetBrains Mono' '10' 'menu-simple.xml' && openbox --reconfigure
